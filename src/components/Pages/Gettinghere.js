    ...
    <div className="GhComponent">
      <div className="GhGrid">
        ...
        <div className="Info">
          <h1>Parking</h1>
          <p>
            Our carpark is CCTV monitored 24hrs a day and free to all of our
            customers. We have spaces for bikes, cars, motorbikes and electric
            car charging points. Our carpark closes at 2am so please be aware
            that your car needs to be moved by this time.
            {/* We offer many different facilities for your convenience at our
            Cinema! There is carparking available, toilets, water refil stations
            and baby changing rooms free for all customers to use. Our Cinema is
            also perfectly located near bus and train statations! Our carparking
            is covered by CCTV 24hrs a day so you can be assured your car is
            safe within our carpark. */}
          </p>
          <h1>Directions</h1>
          <p>
            Use the links below to get directions to us depending on how you
            plan on getting here!
          </p>
          <div className="DirectionBtn">
            <div className="CarBtn dbtn" onClick={() => CarDirections()}>
              <img
                src="https://ik.imagekit.io/x7dbw9vtu/Driving_tpt77NSf5.png"
                alt="ello"
              ></img>
            </div>
            <div className="TrainBtn dbtn" onClick={() => TrainDirections()}>
              <img
                src="https://ik.imagekit.io/x7dbw9vtu/Train_P4f6CwXZH.png"
                alt="ello"
              ></img>
            </div>
            <div className="WalkBtn dbtn" onClick={() => WalkingDirections()}>
              <img
                src="https://ik.imagekit.io/x7dbw9vtu/Walking_JCFc5MmiM.png"
                alt="ello"
              ></img>
            </div>
          </div>
